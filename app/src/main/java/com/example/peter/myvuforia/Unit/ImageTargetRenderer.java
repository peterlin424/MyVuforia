...
import com.example.peter.myvuforia.Activity.VuforiaActivity;
...
//      mTeapot = new Teapot();
    ...
    private void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            // TODO 修改辨識圖：參考辨識物檔案內容
            int textureIndex = trackable.getName().equalsIgnoreCase("low_resolution_image") ? 0
                    : 1;
//            int textureIndex = trackable.getName().equalsIgnoreCase("TestTarget") ? 0
//                    : 1;
